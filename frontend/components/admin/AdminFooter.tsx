...
export default function AdminFooter() {
  return (
    <footer className="bg-blue-900 text-white shadow-lg rounded-lg">
        ...
        <div className="max-w-full mx-auto">
          ...
          <div className="flex justify-between items-start gap-2 mb-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-blue-100 leading-relaxed mb-1.5">
                Sistem Informasi Kerjasama Politeknik Negeri Batam
              </p>
              <div className="flex gap-1.5">
                <a href="#" className="text-blue-300 hover:text-white transition-colors" title="Dokumentasi">
                  <FileText size={12} />
                </a>
                <a href="#" className="text-blue-300 hover:text-white transition-colors" title="Bantuan">
                  <HelpCircle size={12} />
                </a>
                <a href="#" className="text-blue-300 hover:text-white transition-colors" title="Pengaturan">
                  <Settings size={12} />
                </a>
              </div>
            </div>
          ...
          {/* Divider */}
          <div className="h-px bg-[#1E376C]/50 my-1.5"></div>
